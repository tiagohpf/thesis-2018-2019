...
@Component({
  selector: 'inline-member-identification-component',
  templateUrl: 'inline-member-identification.component.html',
  styleUrls: ['inline-member-identification.component.css']
})
export class InlineMemberIdentificationComponent implements OnInit {
