/*
    ...
    WEBCT: Foram feitas alterações ao ficheiro original - forceBaseUrl - com vista à resolução de issues do WebCT.
...
(function( window, undefined ) {
    ...
    var Keycloak = function (config) {
        ...
        function getRealmUrl() {
            ...
            return serverUrl + '/realms/' + encodeURIComponent(kc.realm)
        }
