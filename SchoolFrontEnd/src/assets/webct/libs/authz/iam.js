...
(function (window, undefined) {
    ...
    var Keycloak = function (config) {
        ...
        kc.init = function (initOptions) {
            ...
            if (initOptions) {
                if (typeof initOptions.checkLoginIframe !== 'undefined') {
                    console.log("initOptions.checkLoginIframe" + initOptions.checkLoginIframe);
        ...
        kc.loadUserInfo = function () {
            var url = getRealmUrl() + '/oauth/userinfo';
            var req = new XMLHttpRequest();
            req.open('GET', url, true);
            req.setRequestHeader('Accept', 'application/json');
            req.setRequestHeader('Authorization', 'Bearer ' + kc.token);
        ...
        kc.updateToken = function (minValidity) {
            ...
            var exec = function () {
                ...
                if (!refreshToken) {
                    ...
                    var url = getRealmUrl() + '/oauth/token';
        ...
        function setToken(token, refreshToken, idToken, timeLocal) {
            ...
            if (idToken) {
                ...
                kc.tokenParsed = kc.idTokenParsed;

                var sessionId = kc.realm + '/' + kc.idTokenParsed.sub;
                if (kc.idTokenParsed.session_state) {
                    sessionId = sessionId + '/' + kc.idTokenParsed.session_state;
                }
                kc.sessionId = sessionId;
                kc.authenticated = true;
                kc.subject = kc.idTokenParsed.sub;
                kc.realmAccess = kc.idTokenParsed.realm_access;
                kc.resourceAccess = kc.idTokenParsed.resource_access;

                if (timeLocal) {
                    kc.timeSkew = Math.floor(timeLocal / 1000) - kc.idTokenParsed.iat;
        ...
        function setupCheckLoginIframe() {
            ...
            var src = getRealmUrl() + 'oauth/static/openid-connect/login-status-iframe.html';
        ...
        function checkLoginIframe() {
            ...
            if (loginIframe.iframe && loginIframe.iframeOrigin) {
                ...
                loginIframe.callbackList = [promise];
                ...
                return {
                    ...
                    redirectUri: function (options, encodeHash) {
                        ...
                        if (options && options.redirectUri) {
                            ...
                            if (location.hash && encodeHash && location.href.indexOf('#') > 0) {
